...
function stdfoot($stdfoot = false)
{
    ...
    if ($CURUSER) {
       ...
       The ".$INSTALLER09['site_name']." code monkeys generated this page in ".$r_seconds." seconds and then ate some bananas.<br />"."
       They had to raid the banana tree ".$queries." time".($queries != 1 ? "'s" : "")." ".($queries > 4 ? "<br />".round($queries / 2)." died while climbing the tree! =[" : "=]")."
       ...
       ".($debug ? "| <a title='System View' rel='external' href='/staffpanel.php?tool=system_view'>System View</a> | "."<a rel='external' title='APC' href='/staffpanel.php?tool=apc'>APC Stats</a> | "."<a rel='external' title='Memcache' href='/staffpanel.php?tool=memcache'>Memcache</a>" : "")."";
    }
    $htmlfoot.= "</div>
    </div> <!-- Ends Footer -->
    </body></html>\n";
