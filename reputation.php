...
///////////////////////////////////////////////
      ...
      $mc1->update_row(false, array('reputation' => $res['reputation']));   
...
///////////////////////////////////////////////
    ...
    <link rel='stylesheet' href='./templates/<?php echo $CURUSER['stylesheet'];?>/<?php echo $CURUSER['stylesheet'];?>.css' type='text/css' />
    </head>
    <body>
    <?php
