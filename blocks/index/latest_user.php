...
/** latestuser index **/
    ...
    $latestuser_cache = mysqli_fetch_assoc(sql_query('SELECT id, username, class, warned, chatpost, pirate, king, leechwarn, enabled, donor FROM users WHERE status="confirmed" ORDER BY id DESC LIMIT 1'))/* or sqlerr(__FILE__, __LINE__)*/;
