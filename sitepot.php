...
/** Site Pot **/
$Pot_query = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT value_s, value_i, value_u FROM avps WHERE arg = 'sitepot'") 
...
{
    mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE avps SET value_i = 0, value_s = '0' WHERE arg = 'sitepot'") 
        or sqlerr(__file__, __line__);
