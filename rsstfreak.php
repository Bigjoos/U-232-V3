...
for($i=5;$i<$c;$i+=5) {
  $html .= '<h3><u>'.$feeds[$i].'</u></h3><font class="small">by '.$feeds[$i+3].' on '.$feeds[$i+1].'</font><br /><p>'.str_replace(array('<![CDATA[',']]>'),'',$feeds[$i+4]).'</p><br /><a href="'.$feeds[$i+4].'" target="_blank"><font class="small">Read more</font></a>';
