...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($badnames)) stderr('Hmm', 'I think you forgot the name');
    if (strpos($badnames, ',')) {
    ...
    } else stderr('Error', 'There was an error while saving the file check if this file <b>'.$INSTALLER09['nameblacklist'].'</b> is writable');
} else {
