...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $subject = "Connectability";
		sql_query("INSERT INTO messages (sender, receiver, added, msg, subject) VALUES (0, ".sqlesc($dat['userid']).", '".TIME_NOW."', " . sqlesc($msg) . ", " . sqlesc($subject) . ")") or sqlerr(__FILE__, __LINE__);
    }
    sql_query("INSERT INTO notconnectablepmlog (user, date) VALUES (".sqlesc($CURUSER['id']).", $dt)") or sqlerr(__FILE__, __LINE__);
