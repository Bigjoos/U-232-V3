...
$MY_SELF="{$INSTALLER09['baseurl']}/staffpanel.php?tool=apc"."&amp;SCOPE=".$MYREQUEST['SCOPE'].
	"&amp;SORT1=".$MYREQUEST['SORT1'].
	"&amp;SORT2=".$MYREQUEST['SORT2'].
	"&amp;COUNT=".$MYREQUEST['COUNT'];
$MY_SELF_WO_SORT=
	"{$INSTALLER09['baseurl']}/staffpanel.php?tool=apc".
...
EOB;
	...
	echo
		graphics_avail() ? 
			  '<tr>'.
			  "<td class='td-0'><img alt=\"\" $size src=\"{$INSTALLER09['baseurl']}/staffpanel.php?tool=apc&amp;IMG=1&amp;$time\"></td>".
			  "<td class='td-1'><img alt=\"\" $size src=\"{$INSTALLER09['baseurl']}/staffpanel.php?tool=apc&amp;IMG=2&amp;$time\"></td></tr>\n"
			: "",
		'<tr>',
...
EOB;
	echo 
		"<option value='A",$MYREQUEST['SCOPE']=='A' ? " selected=selected":"","'>Active</option>",
		"<option value='D",$MYREQUEST['SCOPE']=='D' ? " selected=selected":"","'>Deleted</option>",
		"</select>",
		", Sorting:<select name=SORT1>",
		"<option value='H",$MYREQUEST['SORT1']=='H' ? " selected=selected":"","'>Hits</option>",
		"<option value='Z",$MYREQUEST['SORT1']=='Z' ? " selected=selected":"","'>Size</option>",
		"<option value='S",$MYREQUEST['SORT1']=='S' ? " selected=selected":"","'>$fieldheading</option>",
		"<option value='A",$MYREQUEST['SORT1']=='A' ? " selected=selected":"","'>Last accessed</option>",
		"<option value='M",$MYREQUEST['SORT1']=='M' ? " selected=selected":"","'>Last modified</option>",
		"<option value='C",$MYREQUEST['SORT1']=='C' ? " selected=selected":"","'>Created at</option>",
		"<option value='D",$MYREQUEST['SORT1']=='D' ? " selected=selected":"","'>Deleted at</option>";
	if($fieldname=='info') echo
		"<option value=D",$MYREQUEST['SORT1']=='T' ? " selected=selected":"",">Timeout</option>";
	echo 
		'</select>',
		'<select name=SORT2>',
		'<option value=D',$MYREQUEST['SORT2']=='D' ? ' selected=selected':'','>DESC</option>',
		'<option value=A',$MYREQUEST['SORT2']=='A' ? ' selected=selected':'','>ASC</option>',
		'</select>',
		'<select name=COUNT onChange="form.submit()">',
		'<option value=10 ',$MYREQUEST['COUNT']=='10' ? ' selected=selected':'','>Top 10</option>',
		'<option value=20 ',$MYREQUEST['COUNT']=='20' ? ' selected=selected':'','>Top 20</option>',
		'<option value=50 ',$MYREQUEST['COUNT']=='50' ? ' selected=selected':'','>Top 50</option>',
		'<option value=100',$MYREQUEST['COUNT']=='100'? ' selected=selected':'','>Top 100</option>',
		'<option value=150',$MYREQUEST['COUNT']=='150'? ' selected=selected':'','>Top 150</option>',
		'<option value=200',$MYREQUEST['COUNT']=='200'? ' selected=selected':'','>Top 200</option>',
		'<option value=500',$MYREQUEST['COUNT']=='500'? ' selected=selected':'','>Top 500</option>',
		'<option value=0  ',$MYREQUEST['COUNT']=='0'  ? ' selected=selected':'','>All</option>',
		'</select>',
...
EOB;
	echo 
		...
		"</select>",
		", Sorting:<select name=SORT1>",
		"<option value=H",$MYREQUEST['SORT1']=='H' ? " selected=selected":"",">Total Hits</option>",
		"<option value=Z",$MYREQUEST['SORT1']=='Z' ? " selected=selected":"",">Total Size</option>",
		"<option value=T",$MYREQUEST['SORT1']=='T' ? " selected=selected":"",">Number of Files</option>",
		"<option value=S",$MYREQUEST['SORT1']=='S' ? " selected=selected":"",">Directory Name</option>",
		"<option value=A",$MYREQUEST['SORT1']=='A' ? " selected=selected":"",">Avg. Size</option>",
		"<option value=C",$MYREQUEST['SORT1']=='C' ? " selected=selected":"",">Avg. Hits</option>",
		'</select>',
		'<select name=SORT2>',
		'<option value=D',$MYREQUEST['SORT2']=='D' ? ' selected=selected':'','>DESC</option>',
		'<option value=A',$MYREQUEST['SORT2']=='A' ? ' selected=selected':'','>ASC</option>',
