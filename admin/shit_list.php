...
switch ($action2) 
  ...
  stderr('Error', 'The member '.htmlsafechars($arr_name['username']).' is already on your shit list!');
  ...
  if (!$sure)
    stderr('Delete '.htmlsafechars($arr_name['username']).' from shit list',
         'Do you really want to delete <b>'.htmlsafechars($arr_name['username']).'</b> from your shit list?  
