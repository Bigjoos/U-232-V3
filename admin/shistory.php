...
$HTMLOUT .= begin_main_frame();
  ...
  $HTMLOUT .="<tr style='background-color:grey;'><td><span class='size1' style='color:black; '>[$date]&nbsp;[$private]</span>\n ".format_username($user_stuff)."<span class='size2' style='color:black;'> " . format_comment( $arr["text"] ) . "\n</span></td></tr>\n";
  }
  $HTMLOUT .="</table>";
  }
