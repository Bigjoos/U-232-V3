...
$possible_actions = array('show', 'viewapp', 'acceptapp', 'rejectapp','takeappdelete','app');      
...
if ($action == "viewapp") {
    ...
    $HTMLOUT .="<tr><td colspan='2' align='center'>{$lang['uploadapps_application']} " . ($arr["status"] == "accepted" ? "accepted" : "rejected") . " by <b>" . htmlsafechars($arr["moderator"])."</b><br />Comment: " . htmlsafechars( $arr["comment"] ) . "</td></tr></table>
