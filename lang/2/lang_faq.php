...
$lang = array(
    ...
    <br />
    Snapshots are available on the <a href='http://09source.kicks-ass.net/smf/index.php' class='altlink'>Rar downloads</a>. Please note: We do not give any kind of support on the source code so please don't bug us about it. If it works, great, if not too bad. Use this software at your own risk!
    <p>
    Here is a nice tutorial on getting it all to work, written by one of our users: <a href='http://09source.kicks-ass.net'>U-232</a>. Note: This tutorial is not supported by U-232. Please direct all comments on the tutorial to the author, <b>MrMister</b>.</p>",
    ...
    <tr>
      <td class='embedded' bgcolor='#F5F4EA'>&nbsp; <img src='{$INSTALLER09['pic_base_url']}star.gif' alt='Star' /></td>
      <td class='embedded' width='5'>&nbsp;</td>
      <td class='embedded'>Just donate, and send <a class='altlink' href='pm_system.php?action=send_message&amp;receiver=1'>Mindless</a> - and only
